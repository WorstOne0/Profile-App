...
TonalPalette primaryTonalP = toTonalPalette(const Color(0xFF0b5ecd).value);

// Color Scheme
// Generated Primary - 0xFF106D34
ColorScheme lightColorScheme = const ColorScheme(
  brightness: Brightness.light,
  primary: Color(0xFF0b5ecd),
...
ColorScheme darkColorScheme = ColorScheme(
  ...
  onBackground: const Color(0xFFE2E3DE),
  surface: const Color(0xFF1A1C19),
  onSurface: const Color(0xFFE2E3DE),
  surfaceVariant: const Color(0xFF414941),
